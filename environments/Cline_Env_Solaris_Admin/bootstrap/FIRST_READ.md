...
# First-Read-Vertrag: Cline_Env_Solaris_Admin
...
2. Pruefe, dass dieser Pfad lesbar ist und zu `Cline_Env_Solaris_Admin` gehoert.
...
- Nutzer- und Agentendaten werden nur in den Owner-konformen Ordnern unter `users/solaris/` geschrieben.
