# Agent Instructions For Cline_Env_Windows_Admin
...
| --- | --- |
| Short-lived task notes | current agent folder under `users/windows/.../agents/<agent-id>/` |
| Private user preferences | `users/windows/<owner>/memory/USER_MEMORY.md` |
