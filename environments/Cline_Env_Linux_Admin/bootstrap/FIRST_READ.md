...
2. Confirm that the path points to `Cline_Env_Linux_Admin` or to the intended replacement environment.
...
- User and agent data is written only to owner-compatible folders under `users/linux/`.
