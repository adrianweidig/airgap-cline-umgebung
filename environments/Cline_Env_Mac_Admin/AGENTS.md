# Agent Instructions For Cline_Env_Mac_Admin
...
| --- | --- |
| Short-lived task notes | current agent folder under `users/mac/.../agents/<agent-id>/` |
| Private user preferences | `users/mac/<owner>/memory/USER_MEMORY.md` |
