# Start Here: Cline_Env_Mac_Admin
...
```text
Initialize yourself from this path: /Users/Shared/Cline_AirGap/Cline_Env_Mac_Admin or /opt/cline-airgap/Cline_Env_Mac_Admin
```
